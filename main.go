...
func homePage(w http.ResponseWriter, r *http.Request) {
	...
	rows, errQuery := connection.Conn.Query(context.Background(), "SELECT id, project_name, description, technologies FROM public.tb_projects;")
	if errQuery != nil {
	...
	for rows.Next() {
		...
		err := rows.Scan(&each.ID, &each.Projectname, &each.Description, &each.Technologies)
		if err != nil {
